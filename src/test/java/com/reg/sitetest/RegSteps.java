...
public class RegSteps {
	...
	public void i_want_to_reach_the_search_page_from_the_provided_URL() throws Throwable {
		report = new ExtentReports(Constants.PATH + Constants.REPORT_PATH + "navigation report.html", true);
	...
	public void i_want_to_look_up_various_number_plates() throws Throwable {
		report = new ExtentReports(Constants.PATH + Constants.REPORT_PATH + "data search report.html", true);
